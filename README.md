...
- `/FEVM` : Environment setup script.
- `Notebook 0` to `Notebook 5` : Step-by-step demo notebooks.
- `/queries`: batch inference queries with Agent Bricks endpoints
- `/resource_configs`: config files for agent bricks and ai/bi dashboards
## Notes

- Ensure you have the necessary permissions and compute resources.
- Tested on FEVM serverless workspace.
